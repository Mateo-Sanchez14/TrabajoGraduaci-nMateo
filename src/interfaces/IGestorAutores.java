...
public interface IGestorAutores {
    ...
    public final String ERROR_DNI = "El DNI del autor no puede ser nulo";
    public final String ERROR_CLAVE = "La clave ingresada no coincide con la clave repetida";
    ...
    public final String AUTOR_DUPLICADO = "Ya existe un autor con ese nombre ";
    ...
    public String modificarAutor(int autor, String apellidos, String nombres, String cx, String clave, String claveRepetida);
